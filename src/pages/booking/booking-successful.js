			...
			<div className="resetPassword-success">
				...
				<h2 className="resetPassword-success__text">
					...
					<span className="resetPassword-success__text--small">
						{props.isAuth
							? "Check the orders tab for more details, and an e-mail was sent to you. Also make sure to check your junk folder."
							: "Check your e-mail to see your order details. Also make sure to check your junk folder."}
					</span>
				</h2>
			</div>
		</Fragment>
