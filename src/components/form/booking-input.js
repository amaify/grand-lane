...
function BookingInput(props) {
  ...
  const services = [
    ...
    { id: 3, value: "Special Occasion", name: "Special Occasions" },
    { id: 4, value: "Wedding Transfer", name: "Wedding Transfer" },
    { id: 5, value: "Daily Tours", name: "Daily Tours" },
    { id: 6, value: "Wine Tours", name: "Wine Tours" }
  ];
